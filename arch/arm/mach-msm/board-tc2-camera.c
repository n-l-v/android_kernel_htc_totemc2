...
#define CAM_PIN_GPIO_CAM_MCLK1	MSM_CAM_MCLK1	
...
#define CAM_PIN_GPIO_V_CAMIO_1V8_EN_XA		MSM_V_CAMIO_1V8_EN
#define CAM_PIN_GPIO_CAM_PWDN_XB			MSM_NC_GPIO_36
#define CAM_PIN_GPIO_V_CAMIO_1V8_EN_XB		MSM_NC_GPIO_37
...
static struct msm_camera_rawchip_info tc2_msm_rawchip_board_info = {
...
struct platform_device tc2_msm_rawchip_device = {
	.name	= "rawchip",
	.dev	= {
		.platform_data = &tc2_msm_rawchip_board_info,
	},
};
#endif
...
#ifdef CONFIG_I2C
struct i2c_board_info tc2_camera_i2c_boardinfo_XA[] = {
#ifdef CONFIG_S5K4E5YX
	{
...
struct i2c_board_info tc2_camera_i2c_boardinfo_XB[] = {
#ifdef CONFIG_OV5693
	{
...
struct msm_camera_board_info tc2_camera_board_info_XA = {
	.board_info = tc2_camera_i2c_boardinfo_XA,
	.num_i2c_board_info = ARRAY_SIZE(tc2_camera_i2c_boardinfo_XA),
};

struct msm_camera_board_info tc2_camera_board_info_XB = {
	.board_info = tc2_camera_i2c_boardinfo_XB,
	.num_i2c_board_info = ARRAY_SIZE(tc2_camera_i2c_boardinfo_XB),
};
#endif
