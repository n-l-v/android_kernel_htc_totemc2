...
#define ORISE_CABC
#ifdef ORISE_CABC
static char dsi_orise_dim_on_1[] = {0x53, 0x04};
static char dsi_orise_dim_on_2[] = {0x53, 0x2C};
static char dsi_orise_dim_off_1[] = {0x53, 0x0C};
static char dsi_orise_dim_off_2[] = {0x53, 0x24};
static char dsi_orise_pwm3[] = {0x55, 0x01};
#else
...
static struct dsi_cmd_desc sony_orise_display_on_cmds[] = {  
