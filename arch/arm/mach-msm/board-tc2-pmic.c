...
static const struct pm8xxx_adc_map_pt tc2_adcmap_btm_threshold[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = tc2_adcmap_btm_threshold,
	.size = ARRAY_SIZE(tc2_adcmap_btm_threshold),
};
...
#if defined(CONFIG_MACH_TC2) || defined(CONFIG_MACH_DUMMY)
